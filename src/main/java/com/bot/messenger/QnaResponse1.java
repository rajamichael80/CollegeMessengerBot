...
public class QnaResponse1 {
	...
	public static String getJsonResponse(String senderId, String requestText, UserDetail userDetail) {
		...
		case "hi":
			...
			break;		
		case "course":
			jsonResponse = "{ \"recipient\":{ \"id\":\"recipientId\" }, \"message\":{ \"attachment\":{ \"type\":\"template\", \"payload\":{ \"template_type\":\"generic\", \"elements\":[ { \"title\":\"HYPE PLUS\", \"image_url\": \"https://udayanbot.herokuapp.com/img/hype_bse.gif\", \"subtitle\": \"Course Details are given below\", \"buttons\":[ { \"type\":\"web_url\", \"url\": \"http://www.newprinceshribhavani.com/computer-applications.php\", \"title\":\"MCA\" }, { \"type\":\"web_url\", \"url\": \"http://www.newprinceshribhavani.com/computer-science.php\", \"title\":\"Information Technology\" }, { \"type\":\"postback\", \"title\":\"Any Other Query\", \"payload\":\"call our representative\" } ] } ] } } } }";
			break;
		case "view1":
		...
		break;
		case "fondi":
			jsonResponse="{ \"recipient\":{ \"id\":\"recipientId\" }, \"message\":{ \"attachment\":{ \"type\":\"template\", \"payload\":{ \"template_type\":\"generic\", \"elements\":[ { \"title\":\"Fondi d'investimento\", \"image_url\":\"https://udayanbot.herokuapp.com/img/fondi.png\", \"subtitle\":\"L’eccellenza dei fondi sul mercato e le società di gestione che hanno dimostrato nel tempo la migliore strategia\\nPiù di 1800 fondi\", \"buttons\":[ { \"type\":\"web_url\", \"url\":\"http://www.newprinceshribhavani.com/computer-science.php\", \"title\":\"IT\" }, { \"type\":\"web_url\", \"url\":\"https://www.sella.it/banca-online/privati/investimenti-e-risparmio/fondi-sicav-pac.jsp\", \"title\":\"On Boarding\" }, { \"type\":\"postback\", \"title\":\"Any Other Query\", \"payload\":\"call our representative\" } ] } ] } } } } ";
		break;
		case "pir":
		...
		break;
		default:
			jsonResponse = "{ \"recipient\":{ \"id\":\"recipientId\" }, \"message\":{ \"attachment\":{ \"type\":\"template\", \"payload\":{ \"template_type\":\"button\", \"text\":\"I could not understand the request, if you wish I can put you in touch with one of our assistants
.\", \"buttons\":[ { \"type\":\"phone_number\", \"title\":\"Contact Number\", \"payload\":\"+390152434600\" } ] } } } }";
			break; 
		}
